...
import pytest
from source_pickkr.source import PickkrStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PickkrStream, "path", "v0/example_endpoint")
    mocker.patch.object(PickkrStream, "primary_key", "test_primary_key")
    mocker.patch.object(PickkrStream, "__abstractmethods__", set())
